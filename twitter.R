...
library("twitteR")
library("ROAuth")
#Download certificate for hand shake
download.file(url="http://curl.haxx.se/ca/cacert.pem",destfile="cacert.pem")

#https://apps.twitter.com/
#different for each account
#consumerKey="uRDuync3BziwQnor1MZFBKp0x"
consumerKey="PRolI2Uxp2fv785gvqjXqVWKZ"

#consumerSecret="t8QPLr7RKpAg4qa7vth1SBsDvoPKawwwdEhNRjdpY0mfMMdRnV"
consumerSecret="S728ruzcgWQq0IJCbm3ztJ4Lpca904HzUP3l6BDXSq8by7ay33"

#AccessToken="14366551-Fga25zWM1YefkTb2TZYxsrx2LVVSsK0uSpF08sugW"
AccessToken="1031167282179796993-KoITmcAZkse5SO4GOrZ1xfWbIuqkxe"

#AccessTokenSecret="3ap8BZNVoBhE2GaMGLfuvuPF2OrHzM3MhGuPm96p3k6Cz"
AccessTokenSecret="TKOrY3N9M0Pz7oZaHDaFEkfXOKb6sF25qf3hInzYFEaNV"
...
tweets<-homeTimeline(n=15)  #my tweets
...
#------------------------------------
?userTimeline
tweets <- userTimeline("narendramodi", n=100)
#english
tweets[1:5]
