...
freqitems = eclat(tdata, parameter = list(minlen=1, supp=.1 )) # minlen, maxlen, support threshold
#eclat works only on minimum support values
freqitems
inspect(freqitems)
...
rules2.rhs1 <- subset(rules2, rhs %in% c("I2"))
inspect(rules2.rhs1)
